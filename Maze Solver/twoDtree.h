...
public:
   ...
   * You may want a recursive helper function for this one.
   ...
   void pruneHelper(Node* &nd, double tol);
   bool ifPrune(HSLAPixel &avg, Node* node , double tol);
...
private:
   ...
   */
   ...
   twoDtree::Node *pruneHelper(int tol, twoDtree::Node *node);
   void renderPicture(Node* nd, PNG& pic);
   void clearHelper(Node* child);
